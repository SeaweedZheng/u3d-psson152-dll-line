...
public class MySteryJackpot : MonoSingleton<MySteryJackpot>
{
 ...
 //   int mJackpotModel;
    ...
    public JP.JackpotData mJackpotData
    {
        get
        {
            ...
            {
                string cache = SQLitePlayerPrefs03.Instance.GetString(JP_CAME_DATA_CACH, "");
                ...
                else
                {
                    ...
                    SQLitePlayerPrefs03.Instance.SetString(JP_CAME_DATA_CACH, curData);
                }
        ...
        {
            if (value == null)
                SQLitePlayerPrefs03.Instance.SetString(JP_CAME_DATA_CACH, "");
            else
            {
    ...
    bool isDirty = false;
    const string JP_CAME_DATA_CACH = "JP_CAME_DATA_CACH";

    public void Init()
    {
        //  this.mJackpotModel = JM_JPERCENT;
        this.mFactor = 100;
        this.mScoreRate = 1;
        mJpPercent = 0.01;
    ...
    public JP.JackpotInfo JackpotInitData()
    {
        JP.JackpotInfo jInfo =  new JP.JackpotInfo();
        for (int i = 0; i < 4; i++)
        {
