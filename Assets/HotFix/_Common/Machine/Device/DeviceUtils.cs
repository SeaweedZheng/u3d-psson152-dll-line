...
public static class DeviceUtils
{
    ...
    public static int GetCoinOutNum()
    {
        ...
        {
            DebugUtils.LogError($"参数报错： creditTickeOutScale = {_consoleBB.Instance.coinOutScaleTicketPerCredit}  ticketCreditOutScale = {_consoleBB.Instance.coinOutScaleCreditPerTicket}");
        }
        return coinOutNum;
    }
